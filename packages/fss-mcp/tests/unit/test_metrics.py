"""Unit tests for fss_mcp.utils.metrics — OTel per-dispatch recording (L3-11)."""
...
class TestMCPMetricsWithoutOTel:
    ...
    def test_get_metrics_returns_instance(self) -> None:
        from fss_mcp.utils.metrics import MCPMetrics, get_metrics
...
class TestMCPMetricsWithOTel:
    ...
    def mock_meter(self, monkeypatch: pytest.MonkeyPatch) -> dict:
        ...
        monkeypatch.setattr(
            "fss_mcp.utils.telemetry.get_telemetry",
    ...
    def test_call_counter_incremented_on_start(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        with patch("fss_mcp.utils.telemetry.get_telemetry", return_value=mock_telemetry):
            from fss_mcp.utils.metrics import MCPMetrics

"""Unit tests for fss_mcp.middleware.pipeline module."""
...
from fss_mcp.middleware.pipeline import MiddlewarePipeline, MiddlewareResult
...
class TestMiddlewareResult:
    ...
    def test_error_result_from_template_error(self) -> None:
        from fss_core.errors import ValidationError
...
class TestMiddlewarePipelineIOLimits:
    ...
    def test_oversized_response_raises(self) -> None:
        ...
        pipeline = MiddlewarePipeline(config)
        from fss_core.errors import IOLimitError
...
class TestRunFIT:
    ...
    async def test_no_fit_token_passes_through(self) -> None:
        from fss_core.fss_context import fss_fit_token, fss_investigation_id

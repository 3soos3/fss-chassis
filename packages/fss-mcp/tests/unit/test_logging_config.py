"""Unit tests for fss_mcp.logging_config module."""
...
from fss_mcp.logging_config import JSONFormatter
...
class TestSecurityLogger:
    ...
    def reset_security_logger(self) -> None:
        ...
        import fss_mcp.logging_config as lc
    ...
    def test_get_security_logger_returns_logger(self) -> None:
        from fss_mcp.logging_config import get_security_logger

        logger = get_security_logger()
        assert isinstance(logger, logging.Logger)
        assert logger.name == "fss_mcp.security"
    ...
    def test_log_security_event_emits_json(self) -> None:
        from fss_mcp.logging_config import get_security_logger, log_security_event
    ...
    def test_log_security_event_does_not_propagate_to_root(self) -> None:
        ...
        security_records = [r for r in root_records if r.name == "fss_mcp.security"]

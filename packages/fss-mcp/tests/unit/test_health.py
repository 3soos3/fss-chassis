"""Unit tests for fss_mcp.diagnostics.health module."""

import json

import pytest

from fss_mcp.config import DiagnosticSettings, ExtensionSettings, ServerConfig, ServerSettings
from fss_mcp.context import HandlerContext
from fss_mcp.diagnostics.health import _HEALTH_TOOL_NAME, register_health_check
...
class TestHealthCheckOutput:
    ...
    async def test_health_check_contains_chassis_version(self) -> None:
        ...
        assert data["chassis_version"] == fss_mcp.__version__

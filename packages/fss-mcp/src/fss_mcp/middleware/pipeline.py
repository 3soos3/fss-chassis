...
from fss_mcp.security.validation import ValidationLimits, raise_if_invalid
...
class MiddlewareResult:
    ...
    @classmethod
    def error(cls, exc: FSSCoreError) -> MiddlewareResult:
        """Create an error middleware result from a FSSCoreError.
